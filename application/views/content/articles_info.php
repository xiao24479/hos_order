...
<!--						<div class="widget-title">
						...
						<div class="widget-body">
							<form action="?c=weixin&m=test" method="post" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" value="<?php if(isset($author)){echo $author;}else{echo $_COOKIE['l_admin_name'];}?>" class="input-xlarge" name="author" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">描述</label>
									<div class="controls">
										<textarea class="input-xxlarge" rows="3" name="digest"><?php if(isset($digest)){echo $digest;}?></textarea>
									</div>
								</div>
								...
								<div class="control-group">
									<div class="controls">
										...
										<input type="hidden" value="<?php if(isset($action)){echo $action;}?>" class="input-xlarge" name="action" />
										<input type="hidden" value="<?php if(isset($pid)){echo $pid;}?>" class="input-xlarge" name="link_id" />
										<?php if($action=='update'):?><input type="hidden" value="<?php if(isset($tid)){echo $tid;}?>" class="input-xlarge" name="txt_id" /><?php endif;?>
