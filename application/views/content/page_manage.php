				...
				<?php if($type=='publish'):?>
					...
					<div class="row-fluid">
						<div class="span9">
							...
							<div class="span12">
								操作: <span class="check_all opera">全选</span>, <span class="check_null opera">不选</span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  选中项: <span class="opera_blod" onclick="metas_del()">删除</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="?c=pages&m=write"><span class="opera_blod">添加单页</span> </a>
							...
							<div class="span12 well" style="margin-left:0;">
								<table class="table table-striped">
									...
									<tbody>
										<?php foreach($posts as $val):?>
										<tr>
											<td><input name="pid[]" value="<?php echo $val['pid']?>" type="checkbox" style="margin-top: -1px;">&nbsp;&nbsp;<a href="?c=pages&m=write&pid=<?php echo $val['pid'];?>" target="_Blank"><?php echo $val['title'];?></td>
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $val['admin_name']?></td>
											<td><?php echo date('Y-m-d H:i:s',$val['created']);?></td>
											<td><a href="?c=show&m=view&pid=<?php echo $val['pid'];?>" target="_Blank">预览</a></td>
										</tr>
										<?php endforeach;?>
									</tbody>
								</table>
   ...
   <script src="static/js/common-scripts.js"></script>
	<script>
		function metas_del(){
			...
			if(confirm("确定删除吗")){
				  location.href="?c=pages&m=remove&pid="+metas;
			}
