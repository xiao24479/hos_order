...
<!--                            <div class="widget-title">
  ...
  <tr<?php if($i % 2){ echo " class='td1'";}?>>
    ...
    <td><?php echo $sys[$item['sysid']]?></td>
	<td>
	<button class="btn btn-primary" onClick="go_url('?c=system&m=site_info&st_id=<?php echo $item['st_id']?>')"><i class="icon-pencil"></i></button>&nbsp;<button class="btn btn-danger" onClick="go_del('?c=system&m=site_delete&st_id=<?php echo $item['st_id']?>')"><i class="icon-trash"></i></button>
	</td>
  </tr>
