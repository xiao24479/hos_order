...
.date_div{ position:absolute; top:155px; left:120px; z-index:999;}
...
function open9()
{
	...
	diag.Height = 600;
	diag.Title = "个人详细信息";
	diag.URL = "?c=index&m=docter_my_profile";
	diag.show();
}
    ...
    <body style="margin:0 auto;background-color: #f7f7f7;">
       ...
       <div id="content" style="position:absolute; width:100%; height:100%; margin-top:0px;">
           <div id="top" style="position:fixed; z-index: 999; background-color: #f7f7f7;height:120px;">
               <div id="nav_top" style="width:100%;height:15%;background-repeat:no-repeat;"><img style="position:fixed; z-index: 999;" src="static/img/nav.jpg?v=20190428" height="12%" width="100%" /><label style="position:fixed; z-index: 999;margin-left: 82%;margin-top:6px;">
                       ...
                       <img src="static/img/people.png" width="30px;"/><a onclick="open9();" style="color:#fff;padding-left: 8px;"><?php echo $_COOKIE['l_admin_name'];?></a><a href="?c=index&m=logout" style="color:red;padding-left: 8px;"><img src="static/img/logout.png"/></a></label> </div>
           <form action="" method="get" class="date_form order_form" id="order_list_form" style="width:100%;">

<input type="hidden" value="order" name="c" />

<input type="hidden" value="docter_index_xiamen" name="m" />
           <div id="dy_search" style=" position:fixed;width:100%;height:10%;padding-top:10px;z-index: 3;">
               <div style="position:fixed;padding-top:75px;width:100%;height: 50px;line-height: 30px;font-family: '微软雅黑';color: #808080;font-size: 18px;background-color: #f7f7f7;">
               	   <span style="margin-left: 30px;"> 到诊时间：<input type="text" value="<?php echo $start; ?> - <?php echo $end; ?>" style="width:210px;margin-top:8px; vertical-align:middle;height:16px;font-size:12px;" class="input-block-level" name="date" id="inputDate" readonly/> </span>
    ...
    <div class="anniu"><a href="javascript:;" class="btn btn-inverse guanbi"> 关闭 </a><br /><a href="javascript:;" class="btn btn-inverse today"> 今天 </a><br /><a href="javascript:;" class="btn btn-inverse week"> 一周 </a><br /><a href="javascript:;" class="btn btn-inverse month"> 一月 </a><br /><a href="javascript:;" class="btn btn-inverse year"> 一年 </a></div>
           ...
           <div id="dy_table" style="margin-top:200px;">
  ...
  if(!empty($order_list)){
	...
	<td style="text-align:left;">
		...
		<?php echo $this->lang->line('order_time'); ?>：<font id="order_time_<?php echo $item['order_id']; ?>"><?php echo $item['order_time']; ?></font> <font style="color:#333333; " id="order_time_duan_<?php echo $item['order_id']; ?>"><?php if($item['order_time_duan']){ echo $item['order_time_duan'];}?></font><br />
