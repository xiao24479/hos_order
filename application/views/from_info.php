...
<?php if(!empty($info)): ?>
<form action="?c=order&m=from_update" method="post" class="form-horizontal">
<div class="control-group">
	<label class="control-label"><?php echo $this->lang->line('from_name');?></label>
	<div class="controls">
		<input type="text" value="<?php echo $info['from_name']; ?>" class="input-xlarge" name="from_name" />
	</div>
</div>
<div class="control-group">
	<label class="control-label"><?php echo $this->lang->line('from_parent');?></label>
	<div class="controls">
	   <select name="parent_id">
	   <option value="0"><?php echo $this->lang->line('please_select');?></option>
	   <?php foreach($from_list as $val){ ?>
	   <option value="<?php echo $val['from_id'];?>" <?php if($val['from_id'] == $info['parent_id']){ echo "selected";}?>><?php echo $val['from_name'];?></option>
	   <?php } ?>
	   </select>
	</div>
</div>
...
<div class="control-group">
	...
	<div class="controls">
		<input type="text" value="<?php echo $info['from_order']; ?>" class="input-xlarge" name="from_order" />
	</div>
</div>
<div class="control-group">
	<label class="control-label"><?php echo $this->lang->line('is_show');?></label>
	<div class="controls">
	   <input type="radio" value="0" name="is_show" <?php if($info['is_show'] == 0):?> checked <?php endif;?> >&nbsp;&nbsp;显示&nbsp;&nbsp;
	   <input type="radio" value="1" name="is_show" <?php if($info['is_show'] == 1):?> checked <?php endif;?> >&nbsp;&nbsp;隐藏
	</div>
</div>
<div class="control-group">
	<div class="controls">
		<input type="hidden" name="form_action" value="update" /><input type="hidden" name="from_id" value="<?php echo $info['from_id']; ?>" /><input type="submit" name="submit" value="<?php echo $this->lang->line('submit'); ?>" class="btn btn-success"/>  <input name="reset" type="reset" value="<?php echo $this->lang->line('reset'); ?>" class="btn"/>
	</div>
</div>
  </form>
  <?php else:?>
...
<div class="control-group">
	<label class="control-label"><?php echo $this->lang->line('from_name');?></label>
	<div class="controls">
		<input type="text" value="" class="input-xlarge" name="from_name" />
	</div>
</div>
<div class="control-group">
	<label class="control-label"><?php echo $this->lang->line('from_parent');?></label>
...
<div class="control-group">
	<label class="control-label"><?php echo $this->lang->line('order');?></label>
	<div class="controls">
		<input type="text" value="50" class="input-xlarge" name="from_order" />
	</div>
</div>
<div class="control-group">
	<label class="control-label"><?php echo $this->lang->line('is_show');?></label>
	<div class="controls">
	   <input type="radio" value="0" name="is_show">&nbsp;&nbsp;显示&nbsp;&nbsp;
	   <input type="radio" value="1" name="is_show">&nbsp;&nbsp;隐藏
	</div>
</div>
<div class="control-group">
	<div class="controls">
