	...
	<?php echo $sider_menu; ?>
	   <div id="main-content">
			 ...
			 <div class="container-fluid">
				...
				<!-- BEGIN PAGE CONTENT-->
					<div class="row-fluid">
                    <form method="post" action="?c=group&m=update_group" id="tab">
                        <div class="span9" style="margin-top:50px;">
							...
							<div class="content">
								...
								<input name="name" class="span12" placeholder="名称" value="<?=stripslashes($val['name'])?>">
                                 ...
                                 <option value="0">请选择</option>
                                   <?php  foreach($hospital_list as $hospital_list_val){ ?>
                                    <option value="<?php echo $hospital_list_val['hos_id'];?>"><?php echo $hospital_list_val['hos_name'];?></option>
                                    <?php }?>
                                 </select></td>
                                       <td> <label>科室</label>
