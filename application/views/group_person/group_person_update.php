	...
	<?php echo $sider_menu; ?>
	   <div id="main-content">
			 ...
			 <div class="container-fluid">
				...
				<!-- BEGIN PAGE CONTENT--> 
					<div class="row-fluid"> 
                     <form method="post" action="?c=group_person&m=group_person_update" id="tab">
							...
							<div class="content">
								<table>
                                 ...
                                 <option value="0">请选择</option>
                                   <?php  foreach($hospital as $hospital_list_val){ ?>
                                    <option value="<?php echo $hospital_list_val['hos_id'];?>"  <?php if(strcmp($val['hos_id'],$hospital_list_val['hos_id']) == 0 ){echo 'selected';}?>><?php echo $hospital_list_val['hos_name'];?></option>
                                    <?php }?>
                                 </select></td>
                                       <td> <label>科室</label>
			                                 <select name="keshi_id" id="keshi_id">
			                                     <option value="0">请选择</option>
			                                  <?php  foreach($keshi as $keshi_val){ ?>
                                    <option value="<?php echo $keshi_val['keshi_id'];?>"  <?php if(strcmp($val['keshi_id'],$keshi_val['keshi_id']) == 0 ){echo 'selected';}?>><?php echo $keshi_val['keshi_name'];?></option>
                                    <?php }?>
			                                 </select></td>
                                    </tr>
                                 ...
                                 <option value="0">请选择</option>
                                   <?php  foreach($parnt_list as $parnt_list_val){ ?>
                                    <option value="<?php echo $parnt_list_val['id'];?>"  <?php if($val['parent_id'] == $parnt_list_val['id'] ){?>selected <?php }?>><?php echo $parnt_list_val['name'];?></option>
                                    <?php }?>
                                 </select></td>
                                      <td><label>名称</label>
								<input name="name" class="span12" placeholder="名称" value="<?=stripslashes($val['name'])?>">
                                 </td>
                                           ...
                                           <table>
                                              <tr>
	                                       	...
	                                       	<ul id="leftUL"></ul></td>
	                                       	 ...
	                                       	 <ul id="rightUL"><?php echo $rightUL_html;?></ul></td>
                                              </tr>
                                           </table> 
                                     ...
                                     <tr>
                                       <td colspan="2" > <label>组长</label>
		                                 <select name="admin_id" id="admin_id"> 
		                                 <option value="0">请选择</option>
		                                   <?php  foreach($admin as $admin_t){ ?>
		                                    <option value="<?php echo $admin_t['admin_id'];?>"  <?php if($val['admin_id'] == $admin_t['admin_id']){?>selected="selected"<?php }?>><?php echo $admin_t['admin_name'].'_'.$admin_t['admin_username'];?></option>
		                                    <?php }?>
		                                 </select>
                                       </td> 
                                      </tr>
							    ...
							    <input type="hidden" value="<?php echo  $rightUL_admin;?>" id="rightUL_admin">
                                 ...
                                 <p><input type="button" id="check_submit" value="提交"/></p>
							</div> 
						  <?php }?>
						</div>
						</form>
