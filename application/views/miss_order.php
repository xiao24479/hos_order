...
<input type="hidden" value="miss_order" name="m" />
                ...
                <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title" style="background-color:#00a186;">
                             <h4><i class="icon-hospital"></i> 未到诊情况 </h4>
                           <span class="tools">
			  ...
			  <div class="row-fluid">
			    <div class="span6">
                     ...
                     <div class="widget blue">
                         <div class="widget-title" style="background-color:#00a186;">
                             <h4><i class="icon-bell"></i> <?php echo $this->lang->line('notification');?> 未到诊原因</h4>
                           <span class="tools">
                               <a href="javascript:;" class="icon-chevron-down"></a>
                               <a href="javascript:;" class="icon-remove"></a>
                           </span>
                         </div>
                         <div class="widget-body" id="data1" style="overflow: hidden; width: auto; height: 500px;">
                         </div>
                     </div>
                     <!-- END NOTIFICATIONS PORTLET-->
                 </div>
                     ...
                     <div class="widget purple">
                         <div class="widget-title" style="background-color:#00a186;">
                             <h4><i class="icon-hospital"></i>未到诊数据 </h4>
                           <span class="tools">
                               <a href="javascript:;" class="icon-chevron-down"></a>
                               <a href="javascript:;" class="icon-remove"></a>
                           </span>
                         ...
                         <div class="widget-body">
                             <div style="height:auto; width:100%; display:block;">
                                 ...
                                 <tr align=center>
                                  ...
                                  <td><?php echo ($val['count']-$val['come']);?></td>
                                  <td><?php
                                                if($val['count']==0){										
                                                        echo '0%';
                                                }else{										
                                                        echo number_format(((($val['count']-$val['come']) / $val['count']) * 100), 2, '.', '').'%';
                                                }
                                  ?></td>
                                  <td><?php echo $order_huifan_only[$key]['oid'];?></td>
                                  <td><?php echo $order_huifan_only[$key]['come'];?></td>
                                  <td><?php echo $order_huifan[$key]['count']-$order_huifan[$key]['come'];?></td>
                                 </tr>
                                 <?php
                                        }
                                 ?>
...
<script language="javascript">
    ...
    require(
            ...
            var option = {
					...
					series : [
						...
						},
						{
							...
							type:'line',
							smooth:true,
							itemStyle: {normal: {areaStyle: {width:1,type: 'default'}}},
							data:[<?php
							foreach($order as $key=>$val){
								echo $val['count']-$val['come'];
								if($key >= 0)
								{
									echo ",";
								}
						...
						},
						{
							...
							itemStyle: {normal: {areaStyle: {type: 'default'}}},
							data:[<?php
							foreach($order_huifan as $key=>$val){
								echo $val['count'];
								if($key >= 0)
								{
									echo ",";
		...
		function(ce) {
		var myChart1 = ce.init(document.getElementById('data1'));
			option1 = {
				tooltip : {
					trigger: 'item',
				...
				series : [
					{
						...
						data:[
							...
							foreach($res as $key=>$val){
								...
								echo "{value:" . $val['count'];
								echo ",";
								echo " name:'" . $dao_false[$val['type_id']];
								echo "'}";
								}
								if($key >= 0)
								{
