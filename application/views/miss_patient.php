...
<input type="hidden" value="miss_patient" name="m" />
                ...
                <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title" style="background-color:#00a186;">
                             <h4><i class="icon-hospital"></i> 到诊情况 【如发现不显示图表，请检查是否有未选择病种的预约登记】</h4>
                           <span class="tools">
			  ...
			  <div class="row-fluid">
			    <div class="span6">
                     ...
                     <div class="widget blue">
                         <div class="widget-title" style="background-color:#00a186;">
                             <h4><i class="icon-bell"></i> <?php echo $this->lang->line('notification');?> 到诊大病种</h4>
                           <span class="tools">
                               <a href="javascript:;" class="icon-chevron-down"></a>
                               <a href="javascript:;" class="icon-remove"></a>
                           </span>
                         </div>
                         <div class="widget-body" id="data1" style="overflow: hidden; width: auto; height: 450px;">
                 ...
                 <div class="span6">
                     ...
                     <div class="widget red">
                         <div class="widget-title" style="background-color:#00a186;">
                             <h4><i class="icon-comment-alt"></i> <?php echo $this->lang->line('new_post')?> 到诊小病种</h4>
									<span class="tools">
									<a href="javascript:;" class="icon-chevron-down"></a>
									<a href="javascript:;" class="icon-remove"></a>
									</span>
                         </div>
                         <div class="widget-body post_list" id="data2" style="overflow: hidden; width: auto; height: 450px;">
			   ...
			   <div class="row-fluid">
                <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title" style="background-color:#00a186;">
                             <h4><i class="icon-hospital"></i>到诊统计报表 </h4>
                           <span class="tools">
                               <a href="javascript:;" class="icon-chevron-down"></a>
                               <a href="javascript:;" class="icon-remove"></a>
                           </span>
