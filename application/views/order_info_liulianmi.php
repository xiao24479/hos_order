					...
					<div class="widget-body">
						...
						<div class="control-group order_from">
						  ...
						  <?php if(isset($info)){
							   ...
							   <input type="text" name="from_value" id="from_value" value="<?php if(isset($info)){echo $info['from_value']; }?>" class="input-xlarge" readonly  style="width:315px;"/>
						...
						<div class="span6 order_from">
							...
							<div class="control-group order_from">
								...
								<div class="controls">
									...
									<input type="text" value="<?php if(isset($info)){echo $info['pat_name']; }?>" class="input-large" name="patient_name" id="patient_name" />
						...
						<div class="control-group order_from">
							<label class="control-label">关键字</label>
								<div class="controls">
								    <input type="text" name="guanjianzi" id="guanjianzi"  value="<?php if(isset($info)){echo $info['guanjianzi']; }?>" class="input-xlarge"  style="width:367px;"/>
								</div>
						</div>
						...
						<?php foreach($order_remark_list as $order_remark_list_t){
						  ...
						  <?php  }
							...
							<div class="controls">
								...
								<textarea class="input-xxlarge " rows="2" name="remark" style="width:768px; border:1px solid #00F;"><?php if(isset($info)){echo $info['remark']; }?></textarea>
