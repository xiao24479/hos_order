...
<!--			<input type="text" value="" data-trigger="hover" data-placement="right" data-content="【香港区号为：00852】【固定电话格式：075512345678】【手机号码前面不加0】【QQ号以数字填写】" data-original-title="联系方式输入规则" class="input-large popovers" name="patient_phone" id="patient_phone" />-->
                      <input type="text" value="<?php echo $info['pat_phone'];if(!empty($info['pat_phone1'])){ echo "/".$info['pat_phone1']; }?>" data-trigger="hover" data-placement="right" data-content="【香港区号为：00852】【固定电话格式：075512345678】【手机号码前面不加0】【QQ号以数字填写】" data-original-title="联系方式输入规则" class="input-large popovers" name="contact_input" id="contact_input" />
                </div>
...
<div class="control-group order_from">
	...
	<div class="controls">
		...
		<textarea class="input-xxlarge" rows="5" name="con_content" id="con_content" style="width:780px;"><?php echo $con_content; ?></textarea>
...
<div class="control-group order_from">
	...
	<div class="controls">
		...
		<textarea class="input-xxlarge" rows="5" name="con_content" id="con_content" style="width:780px;"></textarea>
