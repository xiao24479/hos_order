...
<body class="fixed-top">
   ...
   <div id="main-content">
         ...
         <div class="container-fluid">
			...
			<input type="hidden" value="cpc_plan_data" name="m" />
			...
			<input type="hidden" value="<?php echo $site_info['site_id']; ?>" name="site_id" />
              <div class="row-fluid">
				<div class="filter_wrapper">
                    ...
                    <div class="filter selected"><?php echo $this->lang->line('cpc_plan_data'); ?></div>
              ...
              <div class="row-fluid">
			    <div class="span12">
				  <div class="widget purple">
                            <div class="widget-title" style="position:relative;">
                                <h4><i class="icon-reorder"></i> <?php echo $site_info['site_name'] . " (" . $site_info['site_domain'] . ") " . $this->lang->line('cpc_plan_data'); ?><select name="type" class="title_select"><option value=""<?php if(empty($type)){ echo " selected "; }?>><?php echo $this->lang->line('all_type'); ?></option><option value="pc"<?php if($type == 'pc'){ echo " selected "; }?>><?php echo $this->lang->line('pc_type'); ?></option><option value="mobile"<?php if($type == 'mobile'){ echo " selected "; }?>><?php echo $this->lang->line('mobile_type'); ?></option></select></h4>
                            <span class="tools">
				...
				<div class="widget-body">
				    <?php if(empty($plan_data)):?>暂无数据<?php else:?>
...
<tr>
	...
	<td><?php echo ($val['dao_lv'] == 0.00)? '':$val['dao_lv'] . '%';?></td></tr>
<?php endforeach;?>
</tbody>
</table>
...
$(function() {
	...
	$(".title_select").change(function(){
		var value = $(this).val();
		var url = "?c=site&m=cpc_plan_data&site_id=<?php echo $site_info['site_id'];?>&date=<?php echo $start; ?> - <?php echo $end; ?>&per_page=<?php echo $page_no; ?>";
