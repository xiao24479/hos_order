...
<body class="fixed-top">
   ...
   <div id="main-content">
         ...
         <div class="container-fluid">
			...
			<input type="hidden" value="site_from_data" name="m" />
			<input type="hidden" value="<?php echo $site_info['site_id']; ?>" name="site_id" />
			  <div class="row-fluid">
				<div class="filter_wrapper">
					...
					<div class="filter selected"><?php echo $this->lang->line('site_from_data'); ?></div>
              ...
              <div class="row-fluid">
			    <div class="span12">
				  <div class="widget purple">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i> <?php echo $site_info['site_name'] . " (" . $site_info['site_domain'] . ")"; ?> <?php echo $this->lang->line('site_from_data'); ?></h4>
                            <span class="tools">
				...
				<div class="widget-body">
				    <?php if(empty($from_data)):?>暂无数据<?php else:?>
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="table table-hover">
  ...
  <tr>
	...
	<th width="100">浏览量</th>
	<th width="100">跳出率</th>
	<th width="200">新访问次数百分比</th>
  </tr>
  </thead>
<tbody>
<?php foreach($from_data as $val):?>
<tr>
	<td><?php echo $val['from_site'] . " / " . $val['type_name'];?></td>
	<td><?php echo $val['views'];?></td>
	<td><?php echo $val['pv'];?></td>
	<td><?php echo number_format(($val['v_pv'] / $val['views']) * 100, 2, ".", "");?>%</td>
	<td><?php echo number_format(($val['v_time'] / $val['views']) * 100, 2, ".", "");?>%</td>
</tr>
<?php endforeach;?>
</tbody>
</table>
