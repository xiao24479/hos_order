      ...
      <div id="main-content">
         ...
         <div class="container-fluid">
          ...
          <div class="widget-body">
            <form method="post" enctype="multipart/form-data" class="form-horizontal" action="/?c=swt&m=swt_data">
           <div class="control-group">
             <label class="control-label"><?php echo $this->lang->line('excel_file');?></label>
             <div class="controls">
               <input type="file" class="input-xlarge" name="userfile" />
             </div>
           </div>
           <div class="control-group">
             <div class="controls">
