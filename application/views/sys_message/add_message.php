	   ...
	   <div id="main-content">
			 ...
			 <div class="container-fluid">
				...
				<!-- BEGIN PAGE CONTENT-->
					...
					<div class="row-fluid">
                                            <form method="post" action="?c=sys_message&m=add_mes">
                                                <div class="span9" style="margin-top:50px;">
							<div class="content">
							
								<label>标题</label>
								
								<input name="message_title" class="span12" placeholder="公告标题" value="">
								...
								<textarea class="input-xxlarge span12" rows="20" name="message_content" id="mes_content"></textarea>
                                                                <p style="height:30px;">是否通过：  是&nbsp;&nbsp;<input type="radio" checked="checked" name="is_pass"value="1" style="margin-top: 0px;"/>&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input type="radio"  name="is_pass" value="0"/></p>
