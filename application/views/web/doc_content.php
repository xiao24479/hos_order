...
<head>
  ...
  <title><?php echo $doc_content['doc_name'];?> - <?php echo $hos_name;?></title>
...
<!--文章内容-->
<blockquote><h1><?php echo $doc_content['doc_name'];?></h1></blockquote>
<article data-am-widget="paragraph" class="am-paragraph am-paragraph-default" data-am-paragraph="{ tableScrollable: true, pureview: true }">
  <img class="am-img-thumbnail"  width="324" height="400" src="static/upload/<?php echo $doc_content['doc_img'];?>" alt="妇产科 医生名字 副主任医师" />
  <?php echo $doc_content['doc_long'];?>
</article>
<!--文章内容-->
