...
<!--                            <div class="widget-title">
	...
	<div class="popover pos_center edit" style="top:60%; left: 40%; display: none;">
		<div class="popover_inner">
			<div class="popover_content jsPopOverContent"><h4 class="popover_title">修改分组</h4>
			<span class="frm_input_box">
			<input type="text" class="form-control js_name" placeholder="" value="">
			<input type="hidden" value="">
			</span></div>

										

			<div class="popover_bar"><a href="javascript:;" class="btn btn-success js_up">确定</a>&nbsp;<a href="javascript:;" class="btn btn_primary js_hide_ins">取消</a>&nbsp;</div>
  ...
  <tr>
	...
	<td><button class="btn btn-primary" onClick="edit(<?php echo $item['id']?>,'<?php echo $item['name']?>')"><i class="icon-pencil"></i></button>&nbsp;<button class="btn btn-danger" onClick="go_url('?c=weixin&m=user_list&gid=<?php echo $item['id']?>')"><i class="icon-user"></i></button></td>
  </tr>
  <?php $i++;endforeach; ?>
  </tbody>
  </table>
