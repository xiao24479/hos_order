...
<form onSubmit="return chkForm();" action="?c=order&m=zmt_order_update" method="post" class="form-horizontal" style="position:relative;">
...
<div class="span5 order_from">
	...
	<div class="control-group order_from">
		...
		<div class="controls">
		   ...
		   <option value="<?php echo $_COOKIE['l_admin_id'];?>"><?php echo $_COOKIE['l_admin_username'];?></option>
...
//						ajax_area('city', province_id, city_id, 2);
						...
						$("#patient_phone").after('<span class="help-inline">可以使用！</span>');
  ...
  if($("#hos_id").find('option:selected').text()=='台州五洲生殖医院'||$("#hos_id").find('option:selected').text()=='台州医院自媒体'){

                        var now_time="<?php echo date("Y-m-d",time()+30*24*60*60);?>";

                        $("#order_time").val(now_time);
