...
function init(d_start,d_end)
{
     ...
     //必须要有内容（奇怪）
     /*************************2002-02-01 MODIFY BY WING *********************************************************************************/
     document.writeln("<div name=\"cele_date\" id=\"cele_date\"  style=\"display:none\"    style=\"LEFT: 70px; POSITION: absolute; TOP: 160px;Z-INDEX:100;\" onClick=\"event.cancelBubble=true;\" onBlur=\"hilayer()\" onMouseout=\"lostlayerfocus()\">&nbsp; </div>");
     /*******************************************MODIFY END*******************************************************************************/
     ...
     temp_str+="<font color=red size=1pt>&nbsp;Su&nbsp;</font></td><td>";temp_str+="<font size=1pt>&nbsp;Mo&nbsp;</font></td><td>"; temp_str+="<font size=1pt>&nbsp;Tu&nbsp;</font></td><td>"; temp_str+="<font size=1pt>&nbsp;We&nbsp;</font></td><td>"
     temp_str+="<font size=1pt>&nbsp;Th&nbsp;</font></td><td>";temp_str+="<font size=1pt>&nbsp;Fr&nbsp;</font></td><td>"; temp_str+="<font color=red size=1pt>&nbsp;Sa&nbsp;</font></td></tr>";
     for (i=1 ;i<=6 ;i++)
     {
     temp_str+="<tr>";
        for(j=1;j<=7;j++){
            temp_str+="<td name=\"c"+i+"_"+j+"\"id=\"c"+i+"_"+j+"\" style=\"CURSOR: hand\" style=\"COLOR:#000000;font-size:8pt;\" language=\"javascript\" onmouseover=\"overcolor(this)\" onmouseout=\"outcolor(this)\" onclick=\"td_click(this)\">&nbsp;</td>"
            }
     temp_str+="</tr>"        
     }
